...
set "PR_LIB_PATH=%CATALINA_HOME%\bin';'%CATALINA_HOME%\..\native-libraries\HEC-DSSVue\lib';'%CATALINA_HOME%\..\native-libraries\HDF5"
set "PR_DEPLOY_PATH=%CATALINA_HOME%\..\wtpwebapps"
"%EXECUTABLE%" //US//%SERVICE_NAME% ++JvmOptions "-Djava.library.path=%PR_LIB_PATH%;-Dwtp.deploy=%PR_DEPLOY_PATH%"
echo Appended Native Libraries HECDssVue and HDF5 to java.library.path - Nicky Sandhu 04/01/2017
echo %PR_LIB_PATH%
echo Set web deploy directory to %PR_DEPLOY_PATH%
:end
cd "%CURRENT_DIR%"
