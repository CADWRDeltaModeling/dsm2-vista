...
${demo.css}
    ...
    $.getJSON('/dsm2.webtools/h5data?file=<%=URLEncoder.encode(request.getParameter("file"),"UTF-8")%>&path=<%=URLEncoder.encode(request.getParameter("path"),"UTF-8")%>', function (data) {
        chart_options = {
                chart: {
                    zoomType: 'x'
                },
