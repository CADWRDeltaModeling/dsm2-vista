...
import dsm2 # you might have to override sys.path if dsm2 exists in lib/Lib. That has been renamed to dsm2ui now for future 
...
if __name__=='__main__':
    ...
    # SAC
    sac = get_data(calsim_file, "/*/C_SAC041")+get_data(calsim_file,"/*/C_CSL004A")+get_data(calsim_file,"/*/C_MOK019")+get_data(calsim_file,"/*/C_C08")
    writedss(outfile, "/CALSIM-SMOOTH/SAC/FLOW//1DAY/ANN-INPUT-2/", sac)
    # EXPORTS
    exports = get_data(calsim_file, "/*/D_OMR027_CAA000")+get_data(calsim_file,"/*/D_OMR028_DMC003")+get_data(calsim_file,"/*/D408")
